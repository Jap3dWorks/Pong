...
namespace Pong {
	...
	{
		_Id = loadTexture(path.c_str(), false);
	}

	Texture::~Texture()
	{
		std::cout << "Texture init destructor\n";
		std::cout << "Texture finish destructor\n";
	}
	...
	Material::~Material()
	{
		std::cout << "Material init destructor\n";
		std::cout << "Material finish destructor\n";
	}
